...
import MetricGraph from './components/MetricGraph.js'
...
export function App() {
	...
	return (
		<div>
			<MetricGraph metrics={throughputReceived} />
			<MetricGraph metrics={throughputTransmitted} />
			<MetricGraph metrics={cpuUsagePercent} />
			<MetricGraph metrics={memAvailable} />
			<MetricGraph metrics={memUsage} />
			<MetricGraph metrics={cpuTemp} />
			<MetricGraph metrics={diskUsed} />
			<MetricGraph metrics={diskUsedPercent} />
		</div>
	);
}
